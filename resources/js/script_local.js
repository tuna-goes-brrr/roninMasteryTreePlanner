...
.then((res) => {
    ...
    function updateMasteryDetail(_textObject,  _skillID) {
        ...
        if (lastVisitedSkillID == null) {
            ...
            msg = "<div><strong>"+ _textObject.tomoe.longName 
                ...
                + masteryData[_skillID].TOMOE_BONUS[skillValueArray[_skillID]]
                + "(/" + masteryData[_skillID].TOMOE_BONUS[masteryData[_skillID].MAX_LEVEL] + ")"
            ...
            msg = "<div><strong>"+ _textObject.longName[_skillID%5] 
                ...
                + masteryData[_skillID].BONUS[skillValueArray[_skillID]]
                + "(/" + masteryData[_skillID].BONUS[masteryData[_skillID].MAX_LEVEL] + ")"
    ...
    function updateTunaBot() {
        ...
        costPoint = 0;
        for (let i = 0; i<15; i++){
            for (let j = 0; j<skillValueArray[i]; j++){
